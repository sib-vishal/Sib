    ...
    return (
        <>
                    ...
                    <div className="row">
                        <div className="col-lg-7 ps-lg-5">
                            ...
                            <ul className="bannerIcon">
                                ...
                                <div className="mt-4">
                                    <Link href="/contact-us"><span className="btnThemeRed me-3"><i className="fa-solid fa-comment-dots"></i> Get a Quote</span></Link>
                                    <Link href="/contact-us"><span className="btnThemewhiteBorder"><i className="fa-solid fa-circle-question"></i> Ask a Question</span></Link>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="row">
                        ...
                        <div className="col-lg-7 mt-lg-0 mt-4">
                            <div className="ps-lg-4">
                                <h2 className="sub_heading fontHeading fontWeight600">Best <span className="text_red">Digital Marketing Company in India</span></h2>
                                ...
                                <div className="rightMain stickyRight">
                                    ...
                                    {activeTab === 'section2' &&
                                        <div className="itemSidebar scroll" id="section2">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Content Marketing</h4>
                                            <p className="mt-3">Content marketing involves creating and distributing valuable, relevant, and consistent content to attract and engage a target audience. Quality content helps build brand authority, drive organic traffic, and nurture relationships with potential customers. It encompasses blog posts, articles, videos, infographics, eBooks, and more.</p>
                                            {/* <div className="row">
                                            <div className="col-lg-6">
                                                <ul className="listItems">
                                    ...
                                    {activeTab === 'section4' &&
                                        <div className="itemSidebar scroll" id="section4">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Email Marketing</h4>
                                    ...
                                    {activeTab === 'section6' &&
                                        <div className="itemSidebar scroll" id="section6">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Affiliate Marketing</h4>
                                            <p className="mt-3">Affiliate marketing is a digital marketing service where businesses partner with affiliates to promote their products or services. Affiliates earn commissions for driving sales or leads through their marketing efforts, making it a cost-effective strategy for businesses to expand their reach and for affiliates to earn income.</p>
                                        </div>
                                    }
                                    {activeTab === 'section7' &&
                                        <div className="itemSidebar scroll" id="section7">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Influencer Marketing</h4>
                                            <p className="mt-3">Influencer marketing is a digital marketing strategy where brands collaborate with individuals who have a significant following on social media to promote their products or services. Influencers create authentic content that resonates with their audience, driving engagement and increasing brand visibility. It's an effective way for brands to reach new customers and build trust through credible endorsements.</p>
                                        </div>
                                    }
                                    {activeTab === 'section8' &&
                                        <div className="itemSidebar scroll" id="section8">
                                            <h4 className="sub_heading fontWeight700 fontHeading">Social Media Optimization (SMO)</h4>
                                            <p className="mt-3">Social Media Optimization (SMO) is a digital marketing approach that enhances a brand's visibility and engagement on social media platforms through organic strategies. This involves optimizing profiles, creating valuable content, engaging with followers, using relevant hashtags, and analyzing performance metrics. SMO increases brand visibility, engagement, and loyalty in a cost-effective manner</p>
                                        </div>
                                    }
                                </div>
                            </div>
                ...
                <div className="containerFull">
                    <div className="row">
                        <div className="col-lg-10">
                            <h3 className="sub_heading text-white fontWeight500 fontHeading">Our Specialized Digital Marketing Services:</h3>
                        </div>
                    </div>
            ...
            <section className="faqsBg">
                <div className="containerFull">
                    <h3 className="sub_heading fontWeight500 text-white fontHeading">Do you have questions about working with Digital Marketing Agency in India? <br className="d-none d-lg-block" /> We’ve got your answers.</h3>
